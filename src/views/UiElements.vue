...
<template>
  ...
  <div
    class="fixed items-center justify-start bottom-8 w-full max-w-sm mx-auto transform translate-y-8 opacity-0 invisible animate-fade-in"
  >
    <div class="bg-gray-800 text-white rounded-lg shadow-lg">
      <div class="flex items-center p-4">
        ...
        <div class="ml-2 flex-grow">
          <div class="text-sm font-medium">Report is saved!</div>
        </div>
        <button class="ml-auto text-sm font-medium text-blue-500 hover:underline">
          Edit report
        </button>
      </div>
      <div class="h-1 bg-gradient-to-r from-[#292B2D] to-[#9CE6A8]"></div>
    </div>
  </div>
</template>
