...
import { editOperatorFirstName } from '@/Api/EditOperatorDetailsApi'
...
const editEmail = async () => {
  ...
  if (token) await editOperatorFirstName(token, first_name.value, props.userId)
}
...
<template>
  ...
  <el-dialog v-model="dialogFormVisible" title="Edit First Name">
    <el-form>
      <el-form-item label="first name" :label-width="formLabelWidth">
        <el-input v-model="first_name" autocomplete="off" />
      </el-form-item>
    </el-form>
    <template #footer>
